...
/** テクスチャのテスト */
public class OGLTexturedTriangleUseK7Style extends JFrame implements GLEventListener{
    ...
    public static void main(String[] args){
        JFrame frame=new OGLTexturedTriangleUseK7Style();
        frame.setVisible(true);
    }

    /** コンストラクタ */
    public OGLTexturedTriangleUseK7Style() {
